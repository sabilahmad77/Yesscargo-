            ...
            <table id="example" class="display nowrap" style="width:100%;">
                ...
                @foreach($InvoicesList as $record)
                    <tr>
                        ...
                        <td>0.00</td>
                        <td>
                            <a href="{{ url('accounts/invoice/download/'.$record->id) }}"
                               class="badge bg-label-primary me-1">Invoice</a>
                        </td>
                        <td class="text-center">
                            ...
                            <a href="{{ url('accounts/invoice/'.$record->id) }}" class="badge bg-label-success me-1">Detail
                                View</a>
                            <a href="{{ route('invoice.edit', $record->id) }}"
                               class="badge bg-label-success me-1">Edit</a>
