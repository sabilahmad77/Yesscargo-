...
<form action="{{ url('/users') }}" method="POST"class="card-body">
    @csrf
    <!-- <h6>1. Account Details</h6> -->
    <div class="row g-3">
    <div class="col-md-6">
        <label class="form-label" for="multicol-username">Username</label>
        <input type="text" name="name" id="multicol-username" class="form-control" placeholder="Add Username" />
    </div>
    <div class="col-md-6">
    ...
    <!-- <div class="col-md-12">
        <label class="form-label" for="multicol-email">Role</label>
            ...
            <select name="role" id="" class="form-control" placeholder="Select Role">
