...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-body">
                 <h5 class="card-title mb-0 mt-2 mb-2"> Current Rate: {{ @$weightPrice[0]->price ?? 0 }}</h5>
                ...
                <form action="{{ url('shipment-weight-price') }}" method="POST">
                    ...
                    <div class="col-6 mb-sm-0 mb-4">
                        ...
                        <input type="number" step="any" name="price"  class="form-control" value="{{ @$weightPrice[0]->price ?? 0 }}" />
                    ...
                    <div class="col-6 mb-sm-0  mb-4">
                        ...
                        <input type="number" step="any" name="price"  class="form-control" value="{{ @$weightPrice[1]->price ?? 0 }}" disabled readonly/>
